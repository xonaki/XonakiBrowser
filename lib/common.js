...
const databaseFilepath = path.join(appDataFolder,appName,"data/db/qrn.browser.db");
...
module.exports =  Object.freeze({
    ...
    ModalWindowOption : {
        ...
        icon: __dirname + '/../resources/qrn.ico'
    },
